...
angular.module('portfolioNgApp').directive('niPersonaAuth', [
  'Persona', '$compile', function(Persona, $compile) {
...
angular.module('portfolioNgApp').directive('niCard', [
  function() {
    var niCard, template;
...
angular.module('portfolioNgApp').directive('niMenu', [
  function() {
    var niMenu;
...
angular.module('portfolioNgApp').directive('niMenuItem', [
  '$compile', 'Menu', function($compile, Menu) {
...
angular.module('portfolioNgApp').factory('Menu', [
  '$resource', '$http', '$rootScope', function($resource, $http, $rootScope) {
    ...
    MenuService.getCards = function(menuId, callback) {
      ...
      return $resource('http://localhost\\:8000/get_cards/:menuId', {
        callback: 'JSON_CALLBACK'
      }, {
        query: {
          method: 'JSONP'
